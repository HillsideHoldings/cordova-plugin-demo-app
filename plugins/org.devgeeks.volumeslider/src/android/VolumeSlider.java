...
public class VolumeSlider extends CordovaPlugin {
	...
	private int cssToViewUnit(double size) {
		return (int) Math.abs(TypedValue.applyDimension(
				TypedValue.COMPLEX_UNIT_DIP, (float) size, cordova
	...
	private void bindVolumeSeekBarToAudioManager(SeekBar volumeSeekBar,
	...
	private void createVolumeSlider(int x, int y, int width, int height) {
		...
		ViewGroup container = (ViewGroup) cordova.getActivity().findViewById(
